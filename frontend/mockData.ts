export const mockOrders = [
  ...
  },
  {
    ...
    customer: 'Ava Baker',
    phone: '07700 901678',
    address: '34 Abbey Road, York, YO1 7JU',
    priority: 'Medium',
    currentStage: 'Field Agent Assigned',
    status: 'In Progress',
    createdDate: '2024-01-11',
    ...
    inventory: { status: 'Available', warehouse: 'York Hub', allocationTime: '2 hours' },
    site: { serviceable: true, technology: 'FTTP', distance: '195m' },
    node: { capacity: 'Available', port: 'Port 7' },
    agent: { name: 'Noah Turner', phone: '07700 901901', region: 'York', vehicle: 'VAN-234' },
    timeline: [
      { time: '06:00', title: 'Order Created', actor: 'System' },
      { time: '06:20', title: 'Site Check Completed', actor: 'Ops Team' },
      { time: '06:40', title: 'Inventory Check Completed', actor: 'System' },
      { time: '07:00', title: 'Node Capacity Verified', actor: 'Network Team' },
      { time: '07:20', title: 'Stock Allocated', actor: 'Warehouse' },
      { time: '07:40', title: 'Payment Verified', actor: 'Ops Team' }
    ]
  },
  {
    orderId: 'ORD-2024-017',
    customer: 'Ethan Cooper',
    phone: '07700 901789',
    address: '67 London Road, Brighton, BN1 4JF',
    priority: 'Low',
    currentStage: 'Site Check',
    status: 'In Progress',
    createdDate: '2024-01-15',
    ...
    inventory: { status: 'Available', warehouse: 'Brighton Depot', allocationTime: '3 hours' },
    site: { serviceable: true, technology: 'FTTP', distance: '270m' },
    node: { capacity: 'Available', port: 'Port 12' },
    agent: { name: 'Isabella Morgan', phone: '07700 902012', region: 'Brighton', vehicle: 'VAN-567' },
    timeline: [
      { time: '11:30', title: 'Order Created', actor: 'System' }
    ]
  },
  {
    orderId: 'ORD-2024-018',
    customer: 'Harper Phillips',
    phone: '07700 901890',
    address: '89 West Street, Southampton, SO14 7NN',
    priority: 'High',
    currentStage: 'Work Completed by Agent',
    status: 'In Progress',
    ...
    inventory: { status: 'Available', warehouse: 'Southampton Hub', allocationTime: '1 hour' },
    site: { serviceable: true, technology: 'FTTP', distance: '140m' },
    node: { capacity: 'Available', port: 'Port 2' },
    agent: { name: 'Mason Evans', phone: '07700 902123', region: 'Southampton', vehicle: 'VAN-890' },
    timeline: [
      { time: '05:00', title: 'Order Created', actor: 'System' },
      { time: '05:20', title: 'Site Check Completed', actor: 'Ops Team' },
      { time: '05:40', title: 'Inventory Check Completed', actor: 'System' },
      { time: '06:00', title: 'Node Capacity Verified', actor: 'Network Team' },
      { time: '06:20', title: 'Stock Allocated', actor: 'Warehouse' },
      { time: '06:40', title: 'Agent Assigned', actor: 'Dispatcher' }
    ]
  },
  {
    orderId: 'ORD-2024-019',
    customer: 'Evelyn Hughes',
    phone: '07700 901901',
    address: '45 North Street, Plymouth, PL1 2LP',
    priority: 'Medium',
    ...
    inventory: { status: 'Available', warehouse: 'Plymouth Depot', allocationTime: '2 hours' },
    site: { serviceable: true, technology: 'FTTP', distance: '205m' },
    node: { capacity: 'Available', port: 'Port 9' },
    agent: { name: 'Lily Carter', phone: '07700 902234', region: 'Plymouth', vehicle: 'VAN-123' },
    timeline: [
      { time: '04:00', title: 'Order Created', actor: 'System' },
      { time: '04:20', title: 'Site Check Completed', actor: 'Ops Team' },
      { time: '04:40', title: 'Inventory Check Completed', actor: 'System' },
      { time: '05:00', title: 'Node Capacity Verified', actor: 'Network Team' },
      { time: '05:20', title: 'Stock Allocated', actor: 'Warehouse' },
      { time: '05:40', title: 'Agent Assigned', actor: 'Dispatcher' },
      { time: '06:00', title: 'Work Completed', actor: 'Field Agent' }
    ]
  },
  {
    orderId: 'ORD-2024-020',
    customer: 'Alexander Ward',
    phone: '07700 902012',
    address: '23 East Road, Leicester, LE1 6RN',
    priority: 'Low',
    currentStage: 'Service Enabled',
    status: 'Completed',
    ...
    inventory: { status: 'Available', warehouse: 'Leicester Hub', allocationTime: '1 hour' },
    site: { serviceable: true, technology: 'FTTP', distance: '185m' },
    node: { capacity: 'Available', port: 'Port 5' },
    agent: { name: 'Aria Mitchell', phone: '07700 902345', region: 'Leicester', vehicle: 'VAN-456' },
    timeline: [
      { time: '03:00', title: 'Order Created', actor: 'System' },
      { time: '03:20', title: 'Site Check Completed', actor: 'Ops Team' },
      { time: '03:40', title: 'Inventory Check Completed', actor: 'System' },
      { time: '04:00', title: 'Node Capacity Verified', actor: 'Network Team' },
      { time: '04:20', title: 'Stock Allocated', actor: 'Warehouse' },
      { time: '04:40', title: 'Agent Assigned', actor: 'Dispatcher' },
      { time: '05:00', title: 'Work Completed', actor: 'Field Agent' },
      { time: '05:20', title: 'Payment Verified', actor: 'Ops Team' },
      { time: '05:40', title: 'Service Enabled', actor: 'System' }
    ]
  }
];
