  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 pb-4">
        <h2 className="text-2xl font-bold text-gray-900">Regulatory & Operations Performance Dashboard</h2>
        <p className="text-sm text-gray-500 mt-1">Openreach KPI Analytics • Reporting Period: FY 2025-2026</p>
      </div>

      {/* PRIMARY KPI CARDS */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        <div className={`bg-white p-5 rounded-lg shadow-sm border ${getStatusBg(99.5, { green: 99, amber: 97 })}`}>
        ...
        <div className={`bg-white p-5 rounded-lg shadow-sm border ${getStatusBg(97.5, { green: 96, amber: 94 })}`}>
        ...
        <div className={`bg-white p-5 rounded-lg shadow-sm border ${getStatusBg(89.5, { green: 88, amber: 85 })}`}>
        ...
        <div className={`bg-white p-5 rounded-lg shadow-sm border ${getStatusBg(4.2, { green: 5, amber: 7 })}`}>
        ...
        <div className={`bg-white p-5 rounded-lg shadow-sm border ${getStatusBg(10.5, { green: 12, amber: 15 })}`}>
        ...
        <div className={`bg-white p-5 rounded-lg shadow-sm border ${getStatusBg(98.2, { green: 97, amber: 95 })}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4">Installation Performance Trend</h3>
          <div className="h-64">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4">Fault Resolution Performance</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4">Regional Performance Comparison</h3>
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={regionalPerformance}>
              ...
              <Tooltip />
              <Legend wrapperStyle={{ fontSize: '11px' }} />
              <Bar dataKey="sla" fill="#002D72" name="SLA Compliance %" radius={[4, 4, 0, 0]} />
              <Bar dataKey="install" fill="#550065" name="Install Performance %" radius={[4, 4, 0, 0]} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4">Order Delay Analytics</h3>
          <div className="space-y-4">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              ...
              <div className="text-2xl font-bold text-[#002D72]">29.5 hours</div>
            </div>
          </div>
        </div>

        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide mb-4">Network Operations Summary</h3>
          <div className="space-y-4">
            <div className="flex justify-between items-center pb-3 border-b border-gray-100">
              <span className="text-sm text-gray-600">Active Service Providers</span>
              <span className="text-lg font-bold text-[#550065]">680+</span>
            </div>
            <div className="flex justify-between items-center pb-3 border-b border-gray-100">
              <span className="text-sm text-gray-600">Field Workforce</span>
              <span className="text-lg font-bold text-[#550065]">37,000</span>
            </div>
            <div className="flex justify-between items-center pb-3 border-b border-gray-100">
              <span className="text-sm text-gray-600">Premises Connected</span>
              <span className="text-lg font-bold text-[#550065]">35M+</span>
            </div>
            <div className="flex justify-between items-center pb-3 border-b border-gray-100">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              ...
              <div className="text-2xl font-bold text-[#002D72]">86.9%</div>
